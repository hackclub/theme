...
// Load these components only on the client side (they use useColorMode or access theme during SSR)
const ColorSwitcher = dynamic(() => import('../components/color-switcher'), { ssr: false })
const NavHeader = dynamic(() => import('../components/nav-header'), { ssr: false })
const HeroSection = dynamic(() => import('../components/hero-section'), { ssr: false })
const TypeScale = dynamic(() => import('@theme-ui/style-guide').then(mod => mod.TypeScale), { ssr: false })
const ColorPalette = dynamic(() => import('@theme-ui/style-guide').then(mod => mod.ColorPalette), { ssr: false })
...
const DocsPage = () => {
  ...
  const handleRapidAction = useCallback(() => {
    showAchievement('🔄 Indecisive! You toggled 10 times in 3 seconds!')
  }, [])

  const { recordAction } = useRapidActionDetector(10, 3000, handleRapidAction)
  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:title" content={`BioX Theme - ${themeName}`} />
        <meta property="og:description" content="BioX theme + React components for Theme UI" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={`BioX Theme - ${themeName}`} />
        <meta name="twitter:description" content="BioX theme + React components for Theme UI" />
